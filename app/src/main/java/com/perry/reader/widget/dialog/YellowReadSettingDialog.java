...
import com.perry.reader.view.adapter.ReadBgAdapter;
...
public class YellowReadSettingDialog extends Dialog {
    ...
    public YellowReadSettingDialog(@NonNull Activity activity, YellowPageLoader mPageLoader) {
