...
import com.perry.reader.widget.animation.CoverPageAnim;
import com.perry.reader.widget.animation.HorizonPageAnim;
import com.perry.reader.widget.animation.NonePageAnim;
import com.perry.reader.widget.animation.PageAnimation;
import com.perry.reader.widget.animation.ScrollPageAnim;
import com.perry.reader.widget.animation.SimulationPageAnim;
import com.perry.reader.widget.animation.SlidePageAnim;


/**
 * 绘制页面显示内容的类
 */
public class YellowPageView extends View {
    ...
    private PageAnimation.OnPageChangeListener mPageAnimListener = new PageAnimation.OnPageChangeListener() {
        ...
        public boolean hasPrev() {
            return YellowPageView.this.hasPrev();
        }

        @Override
        public boolean hasNext() {
            return YellowPageView.this.hasNext();
        }
    ...
    public YellowPageView(Context context) {
        this(context,null);
    }

    public YellowPageView(Context context, AttributeSet attrs) {
        this(context, attrs,0);
    }

    public YellowPageView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    //获取PageLoader
    public YellowPageLoader getPageLoader(boolean isLocal){
        if (mPageLoader == null){
            if (isLocal){
                mPageLoader = new YellowLocalPageLoader(this);
            }
            else {
