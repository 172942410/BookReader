...
import com.perry.reader.utils.ScreenUtils;
import com.perry.reader.utils.StatusBarUtils;
...
import com.perry.reader.view.adapter.ReadCategoryAdapter;
import com.perry.reader.view.base.BaseActivity;
import com.perry.reader.viewmodel.activity.VMBookContentInfo;
import com.perry.reader.viewmodel.activity.VMYellowBookContentInfo;
import com.perry.reader.widget.dialog.ReadSettingDialog;
import com.perry.reader.widget.dialog.YellowReadSettingDialog;
import com.perry.reader.widget.page.NetPageLoader;
import com.perry.reader.widget.page.PageLoader;
import com.perry.reader.widget.page.PageView;
import com.perry.reader.widget.page.TxtChapter;
import com.perry.reader.widget.page.YellowPageLoader;
import com.perry.reader.widget.page.YellowPageView;
...
public class YellowReadActivity extends BaseActivity implements IBookChapters {
...
//    TextView mReadTvCommunity;
    ...
    private static final String TAG = "YellowReadActivity";
    ...
    /*****************view******************/
    private YellowReadSettingDialog mSettingDialog;
    private YellowPageLoader mPageLoader;
    private Animation mTopInAnim;
    private Animation mTopOutAnim;
    private Animation mBottomInAnim;
    private Animation mBottomOutAnim;
    //    private CategoryAdapter mCategoryAdapter;
    private YellowCollBookBean mCollBook;
    //控制屏幕常亮
    ...
    private VMYellowBookContentInfo mVmContentInfo;
    ...
    private ContentObserver mBrightObserver = new ContentObserver(new Handler()) {
        ...
        public void onChange(boolean selfChange, Uri uri) {
            ...
            if (BRIGHTNESS_MODE_URI.equals(uri)) {
                Log.d(TAG, "亮度模式改变");
            } else if (BRIGHTNESS_URI.equals(uri) && !BrightnessUtils.isAutoBrightness(YellowReadActivity.this)) {
                Log.d(TAG, "亮度模式为手动模式 值改变");
                BrightnessUtils.setBrightness(YellowReadActivity.this, BrightnessUtils.getScreenBrightness(YellowReadActivity.this));
            } else if (BRIGHTNESS_ADJ_URI.equals(uri) && BrightnessUtils.isAutoBrightness(YellowReadActivity.this)) {
    ...
    protected void initView() {
        super.initView();
        YellowBookBean.Content content = (YellowBookBean.Content) getIntent().getSerializableExtra(EXTRA_COLL_BOOK);
        //设置书籍
        mCollBook = YellowCollBookHelper.getsInstance().findBookById(content.id);
...
//        mPageLoader = mPvReadPage.getPageLoader(mCollBook.isLocal());
        ...
        if (mPageLoader != null) {
            mPageLoader.setOnPageChangeListener(new YellowPageLoader.OnPageChangeListener() {
                @Override
        ...
        mPvReadPage.setTouchListener(new YellowPageView.TouchListener() {
            @Override
            public void center() {
                toggleMenu(true);
            }
    ...
    private void initData() {
        if (mCollBook != null && mCollBook.isLocal()) {
...
//            chapterBean.setTaskName("下载");
    ...
    public void finishChapters() {
        if (mPageLoader.getPageStatus() == YellowPageLoader.STATUS_LOADING) {
            mPvReadPage.post(() -> {
